...
func New(messages []string, opts ...Option) *Model {
	...
	m.Styles = Styles{
		Border:   theme.DefaultPalette.GetBorder(scope, component, "border", false, lipgloss.RoundedBorder()),
		Text:     theme.DefaultPalette.Get(scope, component, "text", false).PaddingRight(1),
		Selected: theme.DefaultPalette.GetBlended(scope, component, "", true).PaddingLeft(2).PaddingRight(2),
		Dimmed:   theme.DefaultPalette.Get(scope, component, "dimmed", false).PaddingLeft(2).PaddingRight(2),
	}
